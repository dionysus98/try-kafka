...
public class ProducerDemoCallbacks {
    ...
    public static final Logger log = LoggerFactory.getLogger(ProducerDemoCallbacks.class.getSimpleName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int j = 0; j < 10; j++) {
            ...
            // sticky partioner (producer would batch these message to use
            // the same partition
            for (int i = 0; i < 30; i++) {
